...
if(isset($_SESSION['session_username'])){
    header("location:bisa.html"); //halaman utama
    exit();
}
...
if(isset($_POST['login'])){
    ...
    if($username == '' or $password == ''){
        $err .= "<li>Masukkan username dan juga password.</li>";
    }else{
        ...
        if(empty($err)){
            $_SESSION['session_username'] = $username; //tersimpan di server
            $_SESSION['session_password'] = md5($password);

            if($ingataku == 1){
                $cookie_name = "cookie_username"; //tersimpan di browser
            ...
            header("location:bisa.html"); //halaman sekanjutnya
        }
    }
}
?>
    ...
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
        <div class="panel panel-info" >
            <div class="panel-heading">
                <div class="panel-title">Login Untuk Masuk Ke Sistem</div>
            </div>      
